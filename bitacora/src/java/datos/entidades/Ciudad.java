...
@NamedQueries({
    ...
    , @NamedQuery(name = "Ciudad.findByIdPais", query = "SELECT c FROM Ciudad c WHERE c.idPais.id = :idPais")
    , @NamedQuery(name = "Ciudad.findLikeNombre", query = "SELECT c FROM Ciudad c WHERE c.nombre LIKE :nombre")
